# Interactive Alexa Skill

The interactive Alexa storytelling skill.
...
The interactive Alexa skill presents its users with narrative that allows for small changes to the story’s content. On the one hand, the narrative will ask the user whether they would like change the current path of the story, and on the other, the user may add a character name that will be introduced in upcoming story sections.
