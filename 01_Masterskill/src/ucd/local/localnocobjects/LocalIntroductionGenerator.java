 ...
 * Thomas Mildner
 */
public class LocalIntroductionGenerator {

    // Various class variables.
    private LocalNocCharacter nocCharacter   = null;
     ...
     */
    public LocalIntroductionGenerator(String character){
        this.nocCharacter = new LocalNocCharacter(character);
    }
     ...
     */
    public LocalIntroductionGenerator(LocalNocCharacter character){
    ...
    public String getIntroduction(){
        ...
        try {
            ...
            String[] introductions = {getCrossOverIntroduction()};
    ...
    public static void main(String[] args) {
        ...
        List<String> allCharacters = kd.getAllCharacters();
        LocalIntroductionGenerator introductionGenerator;

        for (String character : allCharacters){
            try {
                introductionGenerator = new LocalIntroductionGenerator(character);
                //System.out.println(character + "\t | \t" + introductionGenerator.getIntroduction());
                System.out.println(character + "\t | \t" + introductionGenerator.getCrossOverIntroduction());
            }
            catch(NullPointerException npe){
