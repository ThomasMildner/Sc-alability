...
import static ucd.local.LocalStreamHandler.*;
 ...
 */
public class LocalKnowledgeData{
     ...
     */
    public LocalKnowledgeData(){

        noc_activities          = LOCAL_NOC_LIST.getInvertedField("Typical Activity");
        noc_origin              = LOCAL_NOC_LIST.getInvertedField("Address 1");
        noc_origin              = LOCAL_NOC_LIST.getInvertedField("Address 2", noc_origin);
        noc_origin              = LOCAL_NOC_LIST.getInvertedField("Address 3", noc_origin);
        noc_origin              = LOCAL_NOC_LIST.getInvertedField("Fictional World", noc_origin);
        noc_allQualities        = LOCAL_NOC_LIST.getInvertedField("Negative Talking Points");
        noc_allQualities        = LOCAL_NOC_LIST.getInvertedField("Positive Talking Points", noc_allQualities);

        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Genres");
        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Domains", noc_attributes);
        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Category", noc_attributes);
        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Typical Activity", noc_attributes);
        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Negative Talking Points", noc_attributes);
        noc_attributes          = LOCAL_NOC_LIST.getInvertedField("Positive Talking Points", noc_attributes);

        noc_advocation          = LOCAL_NOC_LIST.getInvertedField("Genres");
        noc_advocation          = LOCAL_NOC_LIST.getInvertedField("Category", noc_advocation);
        noc_advocation          = LOCAL_NOC_LIST.getInvertedField("Domains", noc_advocation);
        noc_advocation          = LOCAL_NOC_LIST.getInvertedField("Typical Activity", noc_advocation);

        noc_allPeople           = LOCAL_NOC_LIST.getInvertedField("Character");
        tc_for                  = LOCAL_CAUSALITY_LIST.getInvertedField("For");
        noc_character           = LOCAL_NOC_LIST.getAllFrames();

        affordances             = LOCAL_AFFORDANCES_LIST.getInvertedField("Past Tense");
        weapon_arsenal          = LOCAL_WEAPON_ARSENAL_LIST.getInvertedField("Affordances");

        positive_counterparts   = LOCAL_COUNTERPARTS_LIST.getInvertedField("Positive Counterpart");
        negative_counterparts   = LOCAL_COUNTERPARTS_LIST.getInvertedField("Negative Counterpart");
    }
