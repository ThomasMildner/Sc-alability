...
public class BlackboardRetriever {
    ...
    /**
     * Returns a String representing the last sentence or section of the story on the blackboard.
     * @return
     *  returns the last sentence or section from the blackboard.
     */
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("Is last item read?: " + br.isLastItemRead());
        //br.resetReadProcess();
